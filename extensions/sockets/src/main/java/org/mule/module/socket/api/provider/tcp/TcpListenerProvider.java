...
@Alias("tcp-listener")
public class TcpListenerProvider implements ConnectionProvider<ListenerConfig, TcpListenerConnection>
{
    ...
    {
        TcpListenerConnection connection = new TcpListenerConnection(tcpServerSocketProperties, protocol, settings.getHost(), settings.getPort());
        connection.connect();
        return connection;
    }
