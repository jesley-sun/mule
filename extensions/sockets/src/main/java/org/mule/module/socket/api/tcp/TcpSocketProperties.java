...
public interface TcpSocketProperties extends SocketProperties
{
    ...
    /**
     * Timeout for blocking operations. A value of 0 (the default) causes to wait indefinitely.
     * <p>
     * When used in a requester:
     * A read() call will block for only this amount of time.
     * <p>
     * When used in a listener:
     * This is the timeout that applies to the "accept" operation.
     */
    int getTimeout();
