...
public class GroupValueSetterTestCase extends AbstractMuleTestCase
{
    ...
    public void before() throws Exception
    {
        ...
        group.addParameter("myName", getField(ExtendedPersonalInfo.class, "name"));
        group.addParameter("age", getField(ExtendedPersonalInfo.class, "age"));

        ParameterGroup child = new ParameterGroup(LifetimeInfo.class, getField(ExtendedPersonalInfo.class, "lifetimeInfo"));
        child.addParameter("dateOfBirth", getField(LifetimeInfo.class, "dateOfBirth"));
