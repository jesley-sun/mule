...
public class HttpMessageProcessTemplate extends AbstractTransportMessageProcessTemplate<HttpMessageReceiver, HttpConnector> implements RequestResponseFlowProcessingPhaseTemplate, ThrottlingPhaseTemplate, EndPhaseTemplate
{
    ...
    protected MuleMessage createMessageFromSource(Object message) throws MuleException
    {
        ...
        muleMessage.setOutboundProperty(HttpConnector.HTTP_REQUEST_PATH_PROPERTY, path);
        ...
        muleMessage.setOutboundProperty(HttpConnector.HTTP_CONTEXT_PATH_PROPERTY,
                                        contextPath
        );

        muleMessage.setOutboundProperty(HttpConnector.HTTP_CONTEXT_URI_PROPERTY,
                                        getInboundEndpoint().getEndpointURI().getAddress()
        );

        muleMessage.setOutboundProperty(HttpConnector.HTTP_RELATIVE_PATH_PROPERTY,
    ...
    protected void processRemoteAddresses(MuleMessage muleMessage)
    {
        ...
        {
            muleMessage.setOutboundProperty(MuleProperties.MULE_REMOTE_CLIENT_ADDRESS,
        ...
        {
            muleMessage.setOutboundProperty(MuleProperties.MULE_REMOTE_CLIENT_ADDRESS,
                                            xForwardedForItems[0]);
            if (xForwardedForItems.length > 1)
            {
                muleMessage.setOutboundProperty(MuleProperties.MULE_PROXY_ADDRESS,
